...
Use motion only when it answers: *Where did this come from? What changed? Where should I look next? Did my action register?*
...
### Accessibility
- **Contrast:** WCAG AA minimum; AAA for body text where reasonable. Contrast is checked against the *effective* background behind glass, not the glass tint alone.
