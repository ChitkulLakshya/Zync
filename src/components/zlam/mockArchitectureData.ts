...
export const mockArchitectureData: ArchitectureDiagram = {
  ...
  nodes: [
    ...
    },
    {
      ...
      type: 'database',
      label: 'MongoDB Atlas',
      sublabel: 'Primary DB · Prisma + Mongoose',
      status: 'healthy',
      techStack: 'MongoDB, Prisma, Mongoose',
      icon: '🗄️',
      tasks: 2,
      teamMembers: ['judy'],
    },
  ...
  edges: [
    ...
    { id: 'e8', source: 'task-service', target: 'mongodb', label: 'Queries', animated: false },
    { id: 'e9', source: 'team-service', target: 'mongodb', label: 'Queries', animated: false },
    { id: 'e10', source: 'team-service', target: 'firebase', label: 'Sync', animated: false },
    { id: 'e11', source: 'ai-service', target: 'mongodb', label: 'Read/Write', animated: false },
    ...
    { id: 'e15', source: 'chat-service', target: 'mongodb', label: 'Persist', animated: false },
  ],
};