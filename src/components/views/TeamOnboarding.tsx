          ...
          <TabsContent value="create">
            <Card className="border-border/10 bg-card/50 backdrop-blur-md shadow-none">
              <CardHeader>
                ...
                <CardDescription>Collaborate with your team in a shared workspace.</CardDescription>
              </CardHeader>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2 pt-2">
                      <p className="text-sm text-muted-foreground">
                        Only people in this list can access
                      </p>
                      <div className="space-y-2 max-h-[200px] overflow-y-auto pr-1">
                        ...
                        {invites.map((invite, idx) => (
                          <div
                            key={idx}
                            className="flex items-center justify-between p-2 rounded-lg hover:bg-foreground/5 text-foreground transition-colors group"
                          >
                            <div className="flex items-center gap-3">
                              <Avatar className="h-8 w-8">
                                <AvatarFallback>
          ...
          <TabsContent value="join">
            <Card className="border-border/10 bg-card/50 backdrop-blur-md shadow-none">
              <CardHeader>
                ...
                <CardDescription>Enter the invite code shared by your team admin.</CardDescription>
              </CardHeader>
