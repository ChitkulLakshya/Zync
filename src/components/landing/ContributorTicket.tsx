        ...
        >
          ...
          <div className="relative mb-8">
            <motion.div 
              ...
              className="relative z-10 w-24 h-24 rounded-full p-[2px] bg-gradient-to-b from-slate-200 to-transparent dark:from-white/20 dark:to-white/5 shadow-elevation5"
            >
              ...
              <motion.div 
                ...
                className="absolute -bottom-1 -right-1 w-8 h-8 rounded-full bg-foreground flex items-center justify-center shadow-lg border-[3px] border-white dark:border-[#0a0a0a]"
              >
      ...
      >
        ...
        <div style={{ transform: "translateZ(40px)" }} className="relative z-10">
          ...
          <div className="flex justify-between items-center mb-8 border-b border-slate-200 dark:border-white/5 pb-4">
            ...
            <div className="text-[10px] font-mono text-foreground/80 bg-slate-200/50 dark:bg-white/5 px-2 py-1 rounded-sm uppercase tracking-wider">
              CONTRIBUTOR #004
            </div>
          </div>
              ...
              {githubUser ? (
                ...
                >
                  <img 
                    ...
                    className="w-20 h-20 rounded-full border-2 border-slate-200 dark:border-white/10 shadow-lg dark:shadow-[0_0_20px_rgba(255,255,255,0.05)] mb-4"
                  />
                ...
                >
                  ...
                  <div className="relative">
                      ...
                      className="w-full h-12 bg-transparent border-b border-slate-300 dark:border-white/10 focus:border-slate-500 dark:focus:border-white/40 outline-none text-foreground placeholder:text-muted-foreground/40 dark:placeholder:text-muted-foreground/30 text-lg transition-colors pb-2"
                      spellCheck={false}
                      required
                    />
                    {isFetchingGithub ? (
            ...
            <AnimatePresence>
              {githubUser && isApproved && (
                <motion.div 
                  ...
                  className="pt-4 border-t border-slate-200 dark:border-white/5 space-y-4 overflow-hidden"
                >
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-10 h-11 bg-slate-100 dark:bg-white/5 border-slate-200 dark:border-white/5 focus-visible:ring-1 focus-visible:ring-slate-300 dark:focus-visible:ring-white/20 text-sm"
                      required
                    />
                  </div>
                  ...
                  <Button 
                    type="submit" 
                    className="w-full h-11 font-medium bg-slate-900 dark:bg-white text-white dark:text-black hover:bg-slate-800 dark:hover:bg-white/90 group"
          ...
          <div className="mt-8 pt-6 border-t border-slate-200 dark:border-white/5 flex items-center justify-between">
            <div className="flex -space-x-2">
               <img src="https://github.com/prem22k.png" className="w-6 h-6 rounded-full border border-white dark:border-[#0a0a0a]" alt="prem22k" />
               <img src="https://github.com/chitkullakshya.png" className="w-6 h-6 rounded-full border border-white dark:border-[#0a0a0a]" alt="chitkullakshya" />
               <img src="https://github.com/eesha264.png" className="w-6 h-6 rounded-full border border-white dark:border-[#0a0a0a]" alt="eesha264" />
            </div>
