        ...
        <a href="#" className="group relative block break-inside-avoid mb-6">
            <div className="relative overflow-hidden bg-card/50 backdrop-blur-md border border-border/10 rounded-2xl">
                ...
                <img
                    ...
                    className={cn("w-full h-auto object-cover transition-all duration-700 will-change-transform group-hover:scale-[1.02]", loaded ? "opacity-100 scale-100" : "opacity-0 scale-[1.02]")}
                    loading="lazy"
            ...
            <div className="mt-3 flex justify-between items-start gap-4 px-1">
                <h3 className="text-sm font-medium leading-tight text-foreground/90 line-clamp-1 group-hover:text-foreground transition-colors">{item.title}</h3>
            </div>
        </a>
    );
};
...
const DesktopPreview = () => {
    ...
    const dummyUsers = [
        { uid: "1", displayName: mockName, email: mockEmail, photoURL: mockAvatar, closeFriends: ["2", "4", "5", "6"] },
        { uid: "2", displayName: "Sarah Connor", email: "sarah@demo.zync.app", photoURL: "https://i.pravatar.cc/150?u=Sarah" },
        { uid: "3", displayName: "John Doe", email: "john@demo.zync.app", photoURL: "https://api.dicebear.com/7.x/adventurer/svg?seed=John" },
        { uid: "4", displayName: "Ada Lovelace", email: "ada@demo.zync.app", photoURL: "https://i.pravatar.cc/150?u=Ada" },
        { uid: "5", displayName: "Grace Hopper", email: "grace@demo.zync.app", photoURL: "https://api.dicebear.com/7.x/pixel-art/svg?seed=Grace" },
        { uid: "6", displayName: "Alan Turing", email: "alan@demo.zync.app", photoURL: "https://api.dicebear.com/7.x/lorelei/svg?seed=Alan" },
        { uid: "7", displayName: "Linus Torvalds", email: "linus@demo.zync.app", photoURL: "https://i.pravatar.cc/150?u=Linus" },
    ];
            ...
            <div className="max-w-7xl mx-auto w-full space-y-8">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-1 text-lg">Manage your AI-generated projects and assignments.</p>
                    </div>
                    <Button size="lg" className="gap-2"><Plus className="w-5 h-5" /> Add Project</Button>
                </div>
                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <Card className="cursor-pointer hover:shadow-md transition-all hover:border-primary/50 group">
                            ...
                            <CardContent className="p-4 pt-2">
                                ...
                                <p className="text-xs text-muted-foreground overflow-hidden h-4 mt-1">Jan 16, 2026</p>
                            </CardContent>
                        </Card>
                    </div>
                </div>
                    ...
                    {[1, 2].map(i => (
                        <Card key={i} className="group hover:shadow-lg transition-all duration-200 border border-border/10 shadow-sm hover:border-border/30 bg-card/50">
                            <CardHeader className="pb-3">
                                ...
                                <CardTitle className="text-xl line-clamp-1 group-hover:text-foreground transition-colors">{i === 1 ? "Zync Dashboard" : "API Gateway"}</CardTitle>
                                <CardDescription className="line-clamp-2 min-h-[40px]">{i === 1 ? "Main dashboard application with GitHub integration." : "Central API gateway for microservices."}</CardDescription>
                            </CardHeader>
                            <CardContent className="pb-3">
                                <div className="flex flex-col gap-2 text-sm text-muted-foreground">
                                    <div className="flex items-center gap-2"><CalendarIcon className="w-4 h-4" /><span>Created Jan 15, 2026</span></div>
                                    <div className="flex items-center gap-2"><User className="w-4 h-4" />
                                        <div className="flex items-center gap-2"><span>Owner</span>
                                            <div className="flex items-center gap-1 bg-secondary/50 pr-2 pl-1 py-0.5 rounded-full">
                                                <Avatar className="w-5 h-5"><AvatarImage src={mockAvatar} /><AvatarFallback>AD</AvatarFallback></Avatar>
                                ...
                                <div className="flex items-center gap-2 mt-3 p-2 bg-secondary/30 rounded-md text-xs">
                                    ...
                                    <span className="truncate flex-1">{mockLogin}/zync-project-{i}</span>
                                </div>
                            </CardContent>
                            <CardFooter className="pt-3 border-t bg-secondary/10 flex gap-2">
                                <Button variant="ghost" className="flex-1 justify-between hover:bg-transparent px-0 text-foreground">
                                    View Architecture <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
                                </Button>
                                <Button variant="ghost" size="icon" className="text-muted-foreground hover:text-foreground hover:bg-secondary"><CheckSquare className="w-4 h-4" /></Button>
                                <Button variant="ghost" size="icon" className="text-muted-foreground hover:text-destructive hover:bg-destructive/10"><Trash2 className="w-4 h-4" /></Button>
                            </CardFooter>
                        </Card>
                    ))}
                </div>
        ...
        <div className="max-w-7xl mx-auto w-full p-6 md:p-8 space-y-8 h-full flex flex-col overflow-hidden bg-transparent custom-scrollbar">
            <div className="mb-8 flex items-start justify-between shrink-0">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Your assigned work across all projects</p>
                </div>
            </div>
                ...
                <div className="space-y-10 pb-20 max-w-4xl">
                    <section>
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <span className="text-[11px] font-medium text-muted-foreground bg-card/50 px-2 py-0.5 rounded-full tabular-nums border border-border/10 backdrop-blur-md">2</span>
                            ...
                            <div className="bg-card/50 border border-border/10 rounded-2xl p-4 transition-all duration-200 hover:border-border/30 hover:bg-card/80 backdrop-blur-xl">
                                <div className="flex items-start gap-3 mb-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center gap-2"><h4 className="text-[15px] font-medium leading-snug">Implement Frontend UI</h4></div>
                                        <div className="flex items-center gap-2 mt-1.5 text-xs text-muted-foreground flex-wrap">
                                            <span className="px-1.5 py-0.5 rounded bg-card/50 border border-border/10 text-muted-foreground backdrop-blur-sm">Frontend</span>
                                            <span className="text-muted-foreground/30">·</span>
                                            <span className="px-1.5 py-0.5 rounded text-xs bg-sky-500/20 text-sky-400">Active</span>
                                            <span className="text-muted-foreground/30">·</span><span className="tabular-nums">Jan 16</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="flex items-center gap-2 flex-wrap">
                                    <Button size="sm" variant="outline" className="h-8 gap-2 text-xs border-border/10 bg-card/50 hover:bg-card/80 backdrop-blur-md"><Terminal className="w-3.5 h-3.5" /> Git Commands</Button>
                                    <Button size="sm" variant="outline" className="h-8 gap-2 text-xs border-border/10 bg-card/50 hover:bg-card/80 backdrop-blur-md"><Layout className="w-3.5 h-3.5" /> Architecture</Button>
                                    <Button size="sm" variant="outline" className="h-8 gap-2 text-xs border-border/10 bg-card/50 hover:bg-card/80 backdrop-blur-md"><Github className="w-3.5 h-3.5" /> Repository<ExternalLink className="w-3 h-3 text-muted-foreground" /></Button>
                                </div>
                            </div>
                        </div>
                    </section>
    ...
    const renderDashboard = () => (
        <div className="h-full w-full overflow-y-auto custom-scrollbar bg-background">
            <DashboardView 
                ...
                isPreview={true}
                mockGitHubData={{
                    stats: { login: "Alex Designer", name: "Alex Designer", public_repos: 12, followers: 8, following: 4, avatar_url: mockAvatar, html_url: "#", connected: true },
                    events: [],
        ...
        <div className="h-full w-full overflow-hidden bg-background">
            <NotesView
                ...
                mockNotes={[
                    ...
                    { id: 'n2', title: 'To-Do List', content: '- Finish the preview mode\n- Push to master', folderId: 'f1', ownerId: '1', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() }
                ]}
            />
        </div>
    );
    ...
    const renderActivityLog = () => {
        const fakeLogs = Array.from({ length: 45 }).map((_, i) => {
            ...
            return {
                ...
                title: i % 3 === 0 ? "Pushed to main branch" : i % 3 === 1 ? "Finished Setup" : "Daily Standup",
                actorName: mockName
            };
        });
            ...
            <div className="h-full w-full overflow-hidden custom-scrollbar bg-background rounded-[2rem]">
                <ActivityLogView 
                    ...
                    tasks={[
                        ...
                        { id: "3", name: "Done Task", status: "Done", commitUrl: "yes", dueDate: new Date(Date.now() - 86400000).toISOString() },
                        { id: "4", name: "Done Task", status: "Done" },
                        { id: "5", name: "Done Task", status: "Done" },
                        { id: "6", name: "Overdue Task", status: "In Progress", dueDate: new Date(Date.now() - 86400000).toISOString(), commitUrl: "yes" }
                    ]}
                    users={dummyUsers}
    ...
    const renderPeople = () => (
        <div className="h-full w-full overflow-hidden bg-background">
            <PeopleView 
                ...
                mockMe={{ uid: '1', displayName: mockName, email: mockEmail, photoURL: mockAvatar, closeFriends: ['2', '4', '5', '6'] } as any}
            />
        </div>
    );
    ...
    const renderSettings = () => (
        <div className="h-full w-full overflow-hidden bg-background">
            <SettingsView 
                ...
                mockMe={{ uid: '1', displayName: mockName, email: mockEmail, photoURL: mockAvatar, closeFriends: ['2', '4', '5', '6'], providerData: [] } as any}
            />
        </div>
    );
            ...
            <div className="w-full max-w-7xl mx-auto p-6 md:p-8 flex flex-col items-start gap-8">
                <div className="w-full flex flex-col md:flex-row justify-between items-end gap-6 border-b border-border/10 pb-6">
                    ...
                    <form className="w-full md:max-w-xs relative group">
                        ...
                        <input className="w-full bg-transparent border-none outline-none pl-6 pr-2 py-2 text-base placeholder:text-muted-foreground/50 focus:placeholder:text-muted-foreground/30 transition-all font-medium" placeholder="Search..." value="web design" readOnly />
                ...
                <div className="flex flex-wrap gap-8 text-sm font-medium tracking-wide">
                    {["All", "Godly", "SiteInspire", "Dribbble", "Lapa Ninja", "Awwwards"].map((cat) => (
                        <button key={cat} className={cn("relative pb-1 uppercase transition-colors hover:text-foreground/80", cat === "All" ? "text-foreground" : "text-muted-foreground")}>
                            {cat}
                            {cat === "All" && <span className="absolute -bottom-1 left-0 w-full h-[2px] bg-foreground" />}
                        </button>
                    ))}
                </div>
            </div>
    ...
    const eventStyleGetter = (event: any) => {
        ...
        if (event.resource?.type === 'project') { backgroundColor = '#10b981'; } 
        else if (event.resource?.type === 'holiday') { backgroundColor = '#f43f5e'; }
        return { style: { backgroundColor, borderRadius: '4px', opacity: 0.9, color: 'white', border: '0px', display: 'block', margin: '2px 4px' } };
    };
        ...
        <div className="max-w-7xl mx-auto w-full p-6 md:p-8 space-y-8 h-full flex flex-col custom-scrollbar">
            <div className="flex items-center justify-end mb-6">
                <div className="flex items-center gap-2">
                    ...
                    <Badge variant="outline" className="h-9 px-3">US</Badge>
                </div>
            </div>
