  ...
  const features = [
    {
      ...
      description:
        'Describe your idea and get a complete project structure, workflows, and task breakdown in seconds.',
    ...
    },
    {
      ...
      description:
        'Collaborate on documents with conflict-free block editing. Real-time cursors keep everyone on the same page.',
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-2xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            From AI-powered planning to GitHub integration—the tools your team needs, without the
            bloat.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 mb-20">
          ...
          <div className="lg:col-span-8 group p-6 sm:p-8 glass-card flex flex-col md:flex-row items-center gap-8 overflow-hidden relative min-h-[400px]">
            ...
            <div className="flex-1 space-y-4 relative z-10">
              <div
                className="w-12 h-12 rounded-2xl bg-background border-0 flex items-center justify-center mb-2 shadow-sm"
                style={{ boxShadow: 'var(--shadow-sm), var(--glass-bevel)' }}
              >
                <Sparkles className="w-5 h-5 text-foreground/80" />
              </div>
              <h3 className="text-2xl font-bold text-foreground ">AI Project Setup</h3>
              <p className="text-muted-foreground text-base leading-relaxed max-w-sm font-light">
                Describe your idea and get a complete project structure, workflows, and task
                breakdown in seconds. Watch it happen live.
              </p>
            </div>
          ...
          <div className="lg:col-span-4 group p-6 sm:p-8 glass-card flex flex-col relative overflow-hidden">
            <div className="absolute inset-0 bg-secondary/30 pointer-events-none" />
            <div
              className="w-12 h-12 rounded-2xl bg-background border-0 flex items-center justify-center mb-6 shadow-sm"
              style={{ boxShadow: 'var(--shadow-sm), var(--glass-bevel)' }}
            >
              <GitBranch className="w-5 h-5 text-foreground/80" />
            </div>
            <h3 className="text-xl font-bold text-foreground mb-3 ">GitHub Sync</h3>
            <p className="text-muted-foreground text-sm leading-relaxed mb-6 font-light">
              Connect repositories and auto-complete tasks when commits are pushed. Your code drives
              your workflow.
            </p>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center py-16 border-t border-border/30">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-foreground">Real-Time Notes</h2>
            <p className="text-muted-foreground mb-6 leading-relaxed font-light">
              Collaborate on documents with conflict-free block editing. Real-time cursors and task
              linking keep everyone on the same page.
            </p>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center py-16 border-t border-border/30">
          <div>
            <h3 className="text-2xl md:text-3xl font-bold text-foreground mb-4">Smart Calendar</h3>
            <p className="text-muted-foreground mb-6 leading-relaxed font-light">
              See your team's schedule at a glance. Plan sprints, set deadlines, and balance
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center py-16 border-t border-border/30">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-foreground">Built-in Chat</h2>
            <p className="text-muted-foreground mb-6 leading-relaxed font-light">
              Discuss tasks, share files, and schedule calls—all without leaving the project
              context.
            </p>
            <div className="space-y-2.5">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center py-16 border-t border-border/30">
          <div>
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed font-light">
              Get notified about what matters. Email and in-app alerts for assignments, deadlines,
              and updates.
            </p>
            <div className="space-y-2.5">
