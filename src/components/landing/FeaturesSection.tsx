/**
 * @fileoverview FeaturesSection.tsx
...
const FeaturesSection = () => {
  ...
  return (
    <section id="features" className="py-10 md:py-28 scroll-mt-20 px-4 sm:px-6">
      <div className="container mx-auto px-4">
        ...
        {/* Real-Time Notes */}
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center py-10 md:py-16 border-t border-border/30">
